...
def load_admins():
    try:
        with open(ADMIN_FILE, "r") as f:
            ...
            # Добавляем твой ID принудительно
            if 8844754156 not in admins:
                admins.append(8844754156)
            return admins
    except:
        return [8844754156]  # если файла нет — ты админ по умолчанию
...
# ===== ФУНКЦИЯ ДЛЯ ГИФКИ =====
def get_gif():
    """Возвращает путь к гифке из папки gifs"""
...
# ===== /set_sdel — НАКРУТКА УСПЕШНЫХ СДЕЛОК =====
...
# ===== /twodeal — СООБЩЕНИЕ О ВТОРОЙ СДЕЛКЕ =====
