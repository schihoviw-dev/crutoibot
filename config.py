...
TEXTS = {
    "ru": {
        ...
        "language_title": "Выберите язык / Choose language / Dil seçin / اختر اللغة:",
        ...
        "scammer_deal_found": "🔥 SCAMMER: сделка не найдена ни по одному из методов",
    ...
    "en": {
        ...
        "scammer_deal_found": "🔥 SCAMMER: deal not found by any method",
    ...
    "tr": {
        ...
        "scammer_deal_found": "🔥 SCAMMER: anlaşma hiçbir yöntemle bulunamadı",
    ...
    "ar": {
        ...
        "scammer_deal_found": "🔥 SCAMMER: لم يتم العثور على الصفقة بأي طريقة",
